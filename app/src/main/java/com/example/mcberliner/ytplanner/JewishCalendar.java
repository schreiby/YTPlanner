...
import com.example.mcberliner.ytplanner.GeoLocation;
...
public class JewishCalendar extends JewishDate {
     ...
     */
    public JewishCalendar(java.util.Calendar calendar) {
        super(calendar);
    }
    ...
    public Date getMoladAsDate() {
        ...
        java.util.Calendar cal = java.util.Calendar.getInstance(geo.getTimeZone());
        cal.clear();
        ...
        cal.set(java.util.Calendar.MILLISECOND, (int) (1000 * (moladSeconds - (int) moladSeconds)));
        // subtract local time difference of 20.94 minutes (20 minutes and 56.496 seconds) to get to Standard time
        cal.add(java.util.Calendar.MILLISECOND, -1 * (int) geo.getLocalMeanTimeOffset());
        return cal.getTime();
    }
    ...
    public Date getTchilasZmanKidushLevana3Days() {
        ...
        cal.setTime(molad);
        cal.add(java.util.Calendar.HOUR, 72); // 3 days after the molad
        return cal.getTime();
    }
    ...
    public Date getTchilasZmanKidushLevana7Days() {
        ...
        java.util.Calendar cal = java.util.Calendar.getInstance();
        cal.setTime(molad);
        cal.add(java.util.Calendar.HOUR, 168); // 7 days after the molad
        return cal.getTime();
    }
    ...
    public Date getSofZmanKidushLevanaBetweenMoldos() {
        ...
        cal.add(java.util.Calendar.MINUTE, 22);
        cal.add(java.util.Calendar.SECOND, 1);
        cal.add(java.util.Calendar.MILLISECOND, 666);
        return cal.getTime();
    }
    ...
    public Date getSofZmanKidushLevana15Days() {
        ...
        java.util.Calendar cal = java.util.Calendar.getInstance();
        cal.setTime(molad);
        cal.add(java.util.Calendar.DAY_OF_YEAR, 15); // 15 days after the molad
        return cal.getTime();
    }
